			...
			success: function(data) {
				...
				arrayDataFaskes.forEach(function(item, index) {
					...
					<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12 mb-3">
						<a href="` + base_url + `/personil/fasilitas-kesehatan/detail/` + item['place_id'] + `" style="text-decoration: none; color : #000;">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-12 py-2">
											...
											<small class="text-dark">Estimasi waktu tempuh : ` + item['duration'] + `</small><br>
