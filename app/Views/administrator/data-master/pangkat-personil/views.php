								...
								<div class="d-flex justify-content-between align-items-center w-100">
									<div class="">
										<div class="d-flex justify-content-between align-items-center">
											...
											<span>Data Pangkat Personil</span>
										</div>
									</div>
												...
												<tr>
													...
													<td style="vertical-align: middle;" clas>
														<div class="list-unstyled d-flex justify-content-center">
															<li class="me-2">
																<a title="Ubah Data" data-title="Ubah Data" data-idpangkat="<?= $row['id_pangkat']; ?>" data-pangkat="<?= $row['pangkat']; ?>" data-singkatan="<?= $row['singkatan']; ?>" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalFormTambahUbah">
			...
			<form id="formTambahUbahData">
				...
				<div class="modal-body">
					...
					<div class="form-group mb-3">
						<label for="pangkat" class="col-form-label col-sm-12">
							Pangkat
						</label>
						<div class="col-sm-12">
					...
					<div class="form-group mb-3">
						<label for="singkatan" class="col-form-label col-sm-12">
							Singkatan
						</label>
						<div class="col-sm-12">
		...
		$(function() {
			...
			$("#formTambahUbahData").submit(function(e) {
				...
				if (action == "tambah") {
					...
					$.ajax({
						type: "POST",
						url: "<?= base_url() ?>/Admin/DataMaster/tambah_pangkat_personil",
						dataType: "JSON",
						data: {
							pangkat: pangkat,
							singkatan: singkatan
					...
					$.ajax({
						type: "POST",
						url: "<?= base_url() ?>/Admin/DataMaster/ubah_pangkat_personil",
						dataType: "JSON",
						data: {
